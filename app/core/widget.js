...
(function Widget(name, id, content) {
    ...
    this.interact = function () {
        var widget_interact = interact(this.element, { preventDefault: 'never' }).draggable({
            inertia: true,
            snap: {
                targets: [interact.createSnapGrid({ x: Layout.cellWidth + Layout.cellOffset, y: Layout.cellHeight + Layout.cellOffset })],
                offset: { x: 2, y: 2 },
                range: Infinity,
